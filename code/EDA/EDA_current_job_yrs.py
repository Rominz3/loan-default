...
sns.histplot(x=sample_data['CURRENT_JOB_YRS'], hue=sample_data['Risk_Flag'], data=data, kde=True, multiple='stack', palette='Set2')
plt.title('Histogram of CURRENT_JOB_YRS with Risk Flag')
plt.xlabel('CURRENT_JOB_YRS')
plt.ylabel('Frequency')
plt.show()

sns.boxplot(x='CURRENT_JOB_YRS', data=data, palette='Set3')
plt.title('Box Plot of CURRENT_JOB_YRS')
